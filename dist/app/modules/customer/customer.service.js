...
const getAllCustomer = (filters, options) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (searchTerm) {
        andConditions.push({
            OR: customer_constant_1.customerFilterableFields.map(field => ({
                [field]: {
                    contains: searchTerm,
                    mode: 'insensitive',
                },
    ...
    if (Object.keys(filterData).length > 0) {
        andConditions.push({
            AND: Object.keys(filterData).map(key => {
                if (customer_constant_1.customerRelationalFields.includes(key)) {
                    return {
                        [customer_constant_1.customerRelationalFieldsMapper[key]]: {
                            id: filterData[key],
                        },
                    };
                }
